...
# Based on https://github.com/kahst/BirdNET/blob/master/analyze.py
# Licensed under MIT License, https://github.com/kahst/BirdNET/blob/master/LICENSE
...
def parseTestSet(path, file_type="wav"):
    # print("Parsing test set, time = ",time.process_time() - start)
...
def main():
    ...
    parser.add_argument("--i", default="input", help="Path to input file or directory.")
    parser.add_argument(
        "--o",
        default="output",
